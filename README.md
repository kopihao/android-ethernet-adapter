...
# What's good?
#### Convenient way to access EthernetManager that is a hidden class of Native Android API.

#### Reflections behind the scene. 
#### Yes you can extend override them anytime. 
...
* Get your new instance simply by:
    1) `new EthernetAdapter(getApplicationContext())` 
